                                  ...
                                  <tr>
                                    <td width="560" valign="top" align="center" class="es-m-p0r esd-container-frame">
                                      <table cellpadding="0" cellspacing="0" width="100%">
                                        <tbody>
                                          <tr>
                                            <td align="center" class="esd-block-image es-p20b es-m-p5t es-m-p5r" style="font-size: 0px">
                                              <a target="_blank">
                                                <img src="https://eotrdfu.stripocdn.email/content/guids/CABINET_e638ae826fdb0aaf3cef1223611f34d4b5c720a20b31a267ca93ecf7bd36862c/images/image.png" alt="Logo" width="200" title="Logo" class="adapt-img" style="display: block; font-size: 12px">
                                              </a>
                                            </td>
                                          </tr>
                                        </tbody>
                                        ...
                                        <tbody>
                                          <tr>
                                            <td align="center" class="esd-block-image es-p10t es-p10b" style="font-size:0px">
                                              <a target="_blank">
                                                <img src="https://eotrdfu.stripocdn.email/content/guids/CABINET_f3fc38cf551f5b08f70308b6252772b8/images/96671618383886503.png" alt="" width="100" style="display:block">
                                              </a>
                                            </td>
                                          </tr>
                                          <tr>
                                          ...
                                          <tr>
                                            <td align="left" class="esd-block-text es-p10t es-p10b">
                                              <p style="font-size:16px">
                                                Hello, {{ $name }}! Thanks for joining us! Please Click On The Below Link To Activate Your Account!
                                              </p>
                                            </td>
                                          </tr>
                                          <br>
                                          <tr>
                                            <td align="left" class="esd-block-text es-p10t es-p10b">
                                                <a href="{{ url('user/confirm/'.$code) }}">Confirm</a>
                                            </td>
                                          </tr>
                                          <tr>
                                            <td align="left" class="esd-block-text es-p10t es-p10b">
                                          ...
                                          <tr>
                                            <td align="left" class="esd-block-text es-p20t es-p10b">
                                              <p style="line-height:150%">
                                                ...
                                                <a target="_blank" href="tel:" style="line-height:150%">
                                                  +000 123 456
                                                </a>
                                                .
                                              </p>
                                                  ...
                                                  <tr>
                                                    <td align="center" valign="top" class="es-p40r">
                                                      <a target="_blank" href="">
                                                        <img title="Facebook" src="https://eotrdfu.stripocdn.email/content/assets/img/social-icons/logo-black/facebook-logo-black.png" alt="Fb" width="32">
                                                      </a>
                                                    </td>
                                                    <td align="center" valign="top" class="es-p40r">
                                                      <a target="_blank" href="">
                                                        <img title="X" src="https://eotrdfu.stripocdn.email/content/assets/img/social-icons/logo-black/x-logo-black.png" alt="X" width="32">
                                                      </a>
                                                    </td>
                                                    <td align="center" valign="top" class="es-p40r">
                                                      <a target="_blank" href="">
                                                        <img title="Instagram" src="https://eotrdfu.stripocdn.email/content/assets/img/social-icons/logo-black/instagram-logo-black.png" alt="Inst" width="32">
                                                      </a>
                                                    </td>
                                                    <td align="center" valign="top">
                                                      <a target="_blank" href="">
                                                        <img title="Youtube" src="https://eotrdfu.stripocdn.email/content/assets/img/social-icons/logo-black/youtube-logo-black.png" alt="Yt" width="32">
                                                      </a>
                                                    </td>
                                                  </tr>
                                                </tbody>
    ...
    <div style="max-width: 600px; margin: 0 auto;" class="email-container">
      ...
      <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;">
          ...
          <td valign="middle" class="hero bg_white" style="padding: 3em 0 2em 0;">
            <img src="{{ asset('front/images/emails/email.png') }}" alt="" style="width: 300px; max-width: 600px; height: auto; margin: auto; display: block;">
          </td>
	      </tr><!-- end tr -->
				<tr>
            	...
            	<tr>
            		<td>
            			<div class="text" style="padding: 0 2.5em; text-align: center;">
            				...
            				<h3>Hello, {{ $name }}! Thanks for joining us! Please Click On The Below Link To Activate Your Account!</h3>
            				<p><a href="{{ url('user/confirm/'.$code) }}" class="btn btn-primary">Confirm</a></p>
            			</div>
            		</td>
                <tr>
