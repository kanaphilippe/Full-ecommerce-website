                    ...
                    <div class="card overflow-hidden">
                        <div class="row g-0">
                            <div class="col-lg-6 d-none d-lg-block p-2">
                                <img src="{{ url('admin/images/auth-img.jpg') }}" alt="" class="img-fluid rounded h-100">
                            </div>
                            <div class="col-lg-6">
                                <div class="d-flex flex-column h-100">
                                    <div class="auth-brand p-4">
                                        <a href="index.html" class="logo-light">
                                            <img src="{{ url('admin/images/logo.png') }}" alt="logo" height="22">
                                        </a>
                                        <a href="index.html" class="logo-dark">
                                            <img src="{{ url('admin/images/logo-dark.png') }}" alt="dark logo" height="22">
                                        </a>
                                    </div>
                                    <div class="p-4 my-auto">
                                        ...
                                        <form action="{{ url('admin/login') }}" method="post">@csrf
                                            <div class="mb-3">
                                                ...
                                                <input name="email" class="form-control" type="email" required="" id="emailaddress"
                                                    placeholder="Enter your email" @if (isset($_COOKIE['email'])) value="{{ $_COOKIE['email'] }}"
                                            ...
                                            <div class="mb-3">
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input"
                                                        id="remember" name="remember" @if (isset($_COOKIE["email"])) checked="" @endif>
