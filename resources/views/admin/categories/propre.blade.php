@if($category['status']==1)
                                                        <a class="updateCmsPageStatus" id="page-{{ $category['id'] }}" category_id="{{ $category['id'] }}" style="color: #5BD1D7; font-size:40px;" href="javascript:void(0)"><i class="mdi mdi-toggle-switch" status="Active"></i></a>&nbsp;&nbsp;&nbsp;
                                                    @else
                                                        <a class="updateCmsPageStatus" id="page-{{ $category['id'] }}" page_id="{{ $category['id'] }}" style="color: red; font-size:40px;" href="javascript:void(0)"><i class="mdi mdi-toggle-switch-off" status="Inactive"></i></a>&nbsp;&nbsp;&nbsp;
                                                    @endif
                                                        <a style="font-size:30px;" href="{{ url('admin/add-edit-cms-page/'.$category['id'])}}"><i class="ri-edit-fill"></i></a>&nbsp;&nbsp;&nbsp;
                                                        <a style="font-size:30px;" class="confirmDelete" name="CMS Page" title="Delete Cms Page" href="javascript:void(0)" record="cms-page" recordid="{{ $category['id'] }}" <?php /*href="{{ url('admin/delete-cms-page/'.$page['id'])}}"*/ ?>><i class="ri-delete-bin-5-line"></i></a>
                            ...
                            <div class="row g-2">
                                ...
                                <div class="form-floating">
                                    <textarea class="form-control" placeholder="Leave a comment here"
                                        id="description" name="description" style="height: 100px">@if(!empty($cmspage['description'])) {{ $cmspage['description'] }} @endif</textarea>
