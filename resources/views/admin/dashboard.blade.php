                ...
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xxl-3 col-sm-6">
                                <a style="text-decoration: none;" href="{{ url('admin/products') }}"><div class="card widget-flat text-bg-info">
                                    <div class="card-body">
                                        <div class="float-end">
                                            <i class="ri-shopping-basket-line widget-icon"></i>
                                        </div>
                                        <h6 class="text-uppercase mt-0" title="Customers">Products</h6>
                                        <h2 class="my-2">{{$productsCount}}</h2>
                                        <p class="mb-0">
                            ...
                            <div class="col-xxl-3 col-sm-6">
                               <a style="text-decoration: none;" href="{{ url('admin/products') }}"> <div class="card widget-flat text-bg-primary">
                                    <div class="card-body">
                                        <div class="float-end">
                            ...
                            <div class="col-xxl-3 col-sm-6">
                                <a style="text-decoration: none;" href="{{ url('admin/categories') }}"><div class="card widget-flat text-bg-primary">
                                    <div class="card-body">
                                        <div class="float-end">
                                            <i class="ri-group-2-line widget-icon"></i>
                                        </div>
                                        <h6 class="text-uppercase mt-0" title="Customers">Categories</h6>
                                        <h2 class="my-2">{{$categoriesCount}}</h2>
                                        <p class="mb-0">
                                            <!--<span class="badge bg-white bg-opacity-10 me-1">8.21%</span>-->
                                            <!--<span class="text-nowrap">Since last month</span>-->
                                        </p>
                             ...
                             <div class="col-xxl-3 col-sm-6">
                                <a style="text-decoration: none;" href="{{ url('admin/brands') }}"><div class="card widget-flat text-bg-primary">
                                    <div class="card-body">
                                        <div class="float-end">
                                            <i class="ri-group-2-line widget-icon"></i>
                                        </div>
                                        <h6 class="text-uppercase mt-0" title="Customers">Brands</h6>
                                        <h2 class="my-2">{{$brandsCount}}</h2>
                                        <p class="mb-0">
                                            <!--<span class="badge bg-white bg-opacity-10 me-1">8.21%</span>-->
                                            <!--<span class="text-nowrap">Since last month</span>-->
                                        </p>
                                                    ...
                                                    <ul class="conversation-list">
                                                        <li class="clearfix">
                                                            <div class="chat-avatar">
                                                                <img src="{{ url('admin/images/users/avatar-5.jpg') }}" alt="male">
                                                                <i>10:00</i>
                                                            </div>
                                                        ...
                                                        <li class="clearfix odd">
                                                            <div class="chat-avatar">
                                                                <img src="{{ url('admin/images/users/avatar-1.jpg') }}" alt="Female">
                                                                <i>10:01</i>
                                                            </div>
                                                            <div class="conversation-text">
                                                                <div class="ctext-wrap">
                                                        ...
                                                        <li class="clearfix odd">
                                                            <div class="chat-avatar">
                                                                <img src="{{ url('admin/images/users/avatar-1.jpg') }}" alt="male">
                                                                <i>10:02</i>
                                                            </div>
                                                            <div class="conversation-text">
                                                                <div class="ctext-wrap">
