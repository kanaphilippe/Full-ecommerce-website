...
<html class="no-js" lang="zxx">
   <head>
      ...
      <!-- CSS here -->
      <link rel="stylesheet" href="{{ url('front/css/preloader.css') }}">
      ...
      <link rel="stylesheet" href="{{ url('front/css/ui-range-slider.css') }}">
      <link rel="stylesheet" href="{{ url('front/css/owl-carousel.css') }}">
      <link rel="stylesheet" href="{{ url('front/css/swiper-bundle.css') }}">
      <link rel="stylesheet" href="{{ url('front/css/backtotop.css') }}">
      <link rel="stylesheet" href="{{ url('front/css/magnific-popup.css') }}">
      <link rel="stylesheet" href="{{ url('front/css/nice-select.css') }}">
      <link rel="stylesheet" href="{{ url('front/flaticon/flaticon.css') }}">
      <link rel="stylesheet" href="{{ url('front/css/font-awesome-pro.css') }}">
   ...
   <body>
    ...
    <!-- footer-end -->
      ...
      <!-- JS here -->
      <script src="{{ url('front/js/vendor/jquery.js') }}"></script>
      <script src="{{ url('front/js/vendor/waypoints.js') }}"></script>
      <script src="{{ url('front/js/bootstrap-bundle.js') }}"></script>
      <script src="{{ url('front/js/meanmenu.js') }}"></script>
      <script src="{{ url('front/js/swiper-bundle.js') }}"></script>
      <script src="{{ url('front/js/tweenmax.js') }}"></script>
      <script src="{{ url('front/js/owl-carousel.js') }}"></script>
      <script src="{{ url('front/js/magnific-popup.js') }}"></script>
      <script src="{{ url('front/js/parallax.js') }}"></script>
      <script src="{{ url('front/js/backtotop.js') }}"></script>
      <script src="{{ url('front/js/nice-select.js') }}"></script>
      ...
      <script src="{{ url('front/js/ui-slider-range.js') }}"></script>
      <script src="{{ url('front/js/isotope-pkgd.js') }}"></script>
      <script src="{{ url('front/js/imagesloaded-pkgd.js') }}"></script>
