...
<section class="checkout-area pb-85">
    <div class="container">
           <p style="font-size: 100px;" id="account-success"></p>
                                <p style="font-size: 100px;" id="account-error"></p><br>
        <form id="accountForm" action="javascript:;" method="post">@csrf
            <div class="row">
                <div class="col-lg-6">
                    <div class="checkbox-form">
                        <h3>Billing Details/Contact Address</h3>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                               ...
                               <div class="country-select">
                                    ...
                                    <select class="select-box select-box"  name="country"  required="">
                            ...
                            <div class="col-md-6">
                                <div class="checkout-form-list">
                                    ...
                                    <input style="background-color: #ccc;" type="email" value="{{ Auth::user()->email }}" placeholder="" readonly="">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="checkout-form-list">
                            ...
                            <div class="col-md-12">
                                <div class="checkout-form-list">
                                    ...
                                    <input type="text" value="{{ Auth::user()->address }}" name="address" placeholder="Street address">
                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="checkout-form-list">
                                    ...
                                    <input type="text" name="city" value="{{ Auth::user()->city }}" placeholder="Town / City">
                                </div>
                                <p id="account-city"></p>
                            </div>
                            <div class="col-md-12">
                            ...
                            <div class="col-md-6">
                                <div class="checkout-form-list">
                                    ...
                                    <input type="text" name="pincode" value="{{ Auth::user()->pincode}}" placeholder="Pincode">
                                </div>
                            ...
                            <button type="submit" class="tp-btn-h1">SAVE</button>
                            </div>
                        </div>
